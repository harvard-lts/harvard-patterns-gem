...
Gem::Specification.new do |spec|
  ...
  spec.description = "This gem provides a set of prebuilt stylesheets and assets for the Harvard Library Patterns. It is designed as a Rails Engine and integrates seamlessly with Rails applications."
  spec.homepage      = "https://github.com/harvard-lts/harvard-patterns-gem"
  spec.required_ruby_version = Gem::Requirement.new(">= 2.3.0")

  # if plan to release gem to RubyGems
